...
<body>
    ...
    <div class="navbar navbar-inverse">
        <div class="navbar-inner">
            ...
            <a class="brand" href="index.html" style="font-weight:700;font-family:Microsoft Yahei">研究生论文送审系统（管理员）</a>
...
<!--                </a>-->
<!--                <ul class="submenu">-->
<!--                <li><a href="--><?php //echo yii\helpers\Url::to(['paper/submitpage']); ?><!--">提交论文</a></li>-->
...
<!---->
            <li>
                ...
                <ul class="submenu">
                <li><a href="<?php echo yii\helpers\Url::to(['student/students']); ?>">学生列表</a></li>
                <li><a href="<?php echo yii\helpers\Url::to(['student/register']); ?>">添加新学生</a></li>
                </ul>
            </li>
            <li>
                <a class="dropdown-toggle" href="#">
                ...
                <ul class="submenu">
                    <li><a href="<?php echo yii\helpers\Url::to(['teacher/teachers']); ?>">教师列表</a></li>
                    <li><a href="<?php echo yii\helpers\Url::to(['teacher/register']); ?>">添加新教师</a></li>
                </ul>
            </li>
<!--            <li>-->
<!--                <a class="dropdown-toggle" href="#">-->
