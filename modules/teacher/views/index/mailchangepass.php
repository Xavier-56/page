...
<body>
<div class="header">
    <h2 style="color: white;margin-left: 38%">研究生论文送审系统(教师)</h2>
</div>
...
<div class="row-fluid login-wrapper">
    <div class="box">
        <div class="content-wrap">
            <h6>修改密码</h6>
            <?php echo $form->field($model, 'username')->textInput( ["class" => "span12",'disabled' => true]); ?>
            <?php echo $form->field($model, 'username')->hiddenInput(); ?>
            <?php echo $form->field($model, 'password')->passwordInput(["class" => "span12", "placeholder" => "新密码"]); ?>
